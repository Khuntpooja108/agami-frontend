    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="w-3/4 flex flex-col bg-gray-200">
                {selectedAdmin ? (
                    <>
                        <div className="p-4 bg-gray-500 text-white shadow-md flex items-center">
                        ...
                        <div className="flex-1 p-4 overflow-y-auto space-y-2">
                            {messages.map((msg, i) => (
                                <div
                                    key={i}
                                    className={`flex w-full ${(msg.senderId || msg.sender_id )=== user.id ? "justify-end" : "justify-start"
                                        }`}
                                >
                                    <div
                                        className={`p-3 rounded-lg max-w-[75%] break-words ${(msg.senderId || msg.sender_id )=== user.id
                        ...
                        <div className="p-4 bg-white flex items-center border-t">
                            ...
                            />
                            <button
                                className="ml-3 bg-gray-500 text-white px-4 py-2 rounded-full"
                                onClick={sendMessage}
                            >
                                Send
                            </button>
